...
export const CameraSetup: {
    ...
    A: {
        position: new THREE.Vector3(290, 240, -660),
        rotation: new THREE.Vector3(0, 0, 0)
    },
    B: {
        position: new THREE.Vector3(320, 200, -550),
        rotation: new THREE.Vector3(0, 0, 0)
    },
    C: {
        position: new THREE.Vector3(340, 125, -400),
        rotation: new THREE.Vector3(0, 0, 0)
    },
    D: {
        position: new THREE.Vector3(190, 30, -320),
        rotation: new THREE.Vector3(0, 0, 0)
    },
    E: {
        position: new THREE.Vector3(25, 10, -250),
        rotation: new THREE.Vector3(0, 0, 0)
    },
    F: {
        position: new THREE.Vector3(-140, 10, -190),
        rotation: new THREE.Vector3(0, 0, 0)
    },
    G: {
        position: new THREE.Vector3(-340, 10, -100),
        rotation: new THREE.Vector3(0, 0, 0)
    },
    H: {
